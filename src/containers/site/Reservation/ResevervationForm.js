...
const ReservationForm = ( props ) => {
    ...
    // Effect hook to fetch hours from the API on component mount
    // So it can defined the hours
    useEffect(() => {
    ...
    validationSchema: Yup.object().shape({
        date: Yup.string()
            .test(
                ...
                function (value) {
                    const hours = props.hours[moment(value, "YYYY-MM-DD").isoWeekday()];
                    return (
                        (hours.lunch_opening_time !== "FERME" && hours.lunch_opening_time !== "") ||
                        (hours.dinner_opening_time !== "FERME" && hours.dinner_opening_time !== "")
                    );
                }
            )
            .test(
