    ...
    return (
        ...
        >
            ...
            <span className="pb-5">
                ...
                <h3 className="pt-5">Article 4 - Gestion du site</h3>
                <p>
                ...
                <h3 className="pt-5">Article 5 - Responsabilités</h3>
                <p>
                ...
                <h3 className="pt-5">Article 6 - Liens hypertextes</h3>
                <p>
                ...
                <h3 className="pt-5">Article 7 - Collecte et protection des données</h3>
                <p>
                    Vos données sont collectées par la société Le Quai Antique.
                ...
                <h3 className="pt-5">Article 8 - Droit d’accès, de rectification et de déréférencement de vos données</h3>
                <p>
                    ...
                    00 Rue fictive 75000 Paris  .

                    Ou par email, à l’adresse :
                    Lequaiantique@exemple.com
                ...
                <h3 className="pt-5">Article 9 - Utilisation des données</h3>
                <p>
                ...
                <h3 className="pt-5">Article 10 - Politique de conservation des données</h3>
                <p>
                ...
                <h3 className="pt-5">Article 11- Partage des données personnelles avec des tiers</h3>
                <p>
                ...
                <h3 className="pt-5">Article 12 - Offres commerciales</h3>
                <p>
                    Vous êtes susceptible de recevoir des offres commerciales de l'éditeur. Si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : lien.com.
                    Vos données sont susceptibles d’être utilisées par les partenaires de l'éditeur à des fins de prospection commerciale, si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : lien.com.
                ...
                <h3 className="pt-5">Article 13 - Cookies</h3>
                <p>
                ...
                <h3 className="pt-5">Article 14 - Photographies et représentation des produits</h3>
                <p>
                    Les photographies de produits, accompagnant leur description, ne sont pas contractuelles et n'engagent pas l'éditeur.
                </p>
                <h3 className="pt-5">Article 15 - Loi applicable</h3>
                <p>
                ...
                <h3 className="pt-5">Article 16 - Contactez-nous</h3>
                <p>
