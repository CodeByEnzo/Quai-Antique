...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 02 mars 2023 à 10:06
...
INSERT INTO `clients` (`client_id`, `username`, `email`, `password`, `statut`, `created_at`, `updated_at`, `token`) VALUES
(1, 'JohnDoe', 'johndoe@example.com', '$2y$10$MzsKnIOZLOTogNOp5xWYpuDdhUr2mz327lJHLtffgqUAt9GGM53PO', 'active', '2023-01-29 09:10:42', '2023-01-31 20:41:45', NULL),
(19, 'bearice barisien', 'bea.barisien@gmail.com', '$2y$10$jlW8.Ptg7w8lvFQe0xtyk.fnidoAq60x.yUjdrCSgYT75VHU75ozq', 'active', '2023-01-31 21:49:28', '2023-01-31 21:49:28', NULL),
(24, 'Alicia Keys', 'aliciak@gmail.com', '$2y$10$gcCKu9BNXDQfl9M9ruPFP.cc3LXnE/dSYM90j4s2HokX9URLEnpb.', 'active', '2023-01-31 22:22:31', '2023-01-31 22:22:31', NULL),
(25, 'joshua mwa', 'joshuaall@gmail.com', '$2y$10$jiV2gCueo5jeiBe/gj6jT.f7BR1BXV9vmmIFHAvUsekFHFdL7VT4q', 'active', '2023-01-31 22:24:09', '2023-01-31 22:24:09', NULL),
(26, 'nicolas sss', 'sssnico@gmail.com', '$2y$10$/fHT778JXMxWeKroXUuEC.8mijVWYxULflWRCPqYMq3GHWeAJhSMm', 'active', '2023-02-01 20:06:06', '2023-02-01 20:06:06', NULL),
(27, 'albert einstein', 'einstein@gmail.com', '$2y$10$RYAwHPHSN8o2Mo3.o04ekeuUYkPXbowzrbpe3.oaz1OhqFqEYpOmW', 'active', '2023-02-02 11:51:39', '2023-02-02 11:51:39', NULL),
(31, 'Snowee', 'Hellosnowee@gmail.com', '$2y$10$3wLvsRMGpMUOwmj2cTViT.MlJvMQTIzXkKQZLG4zkGA1XHZOM7M5u', 'active', '2023-02-11 18:12:49', '2023-02-11 18:12:49', NULL),
(32, 'albert montana', 'albertalbert@gmail.com', '$2y$10$5Y0lnORgJiG.oUzzILfWV.ZLd7vzNu/G2fd3zDZRlOvAtv1msRjC6', 'active', '2023-02-21 18:37:58', '2023-02-21 18:37:58', NULL),
(33, 'azertyuiop', 'Azertyuiop@gmail.com', '$2y$10$2fjilXQE/7ehaBS8w3vF1ukNc/eIgydFEaHjAodtL/ODrCsYraf5C', 'active', '2023-02-22 09:53:37', '2023-02-22 09:53:37', NULL),
(39, '', '', '$2y$10$WYWQ5y6aiHobJPasfiz1U.Di/7jKoSavSCD9KbrvCThCOrg5C4p/m', 'active', '2023-02-24 22:41:03', '2023-02-24 22:41:03', NULL),
(40, 'blabla', 'blabla@gmail.com', '$2y$10$GvnPyiyBYfW3W8aVqj7Xx.ahx5.NbCnR8NE6Av3033KTERoNLaAoq', 'active', '2023-02-26 20:17:37', '2023-02-26 20:17:37', NULL);
...
(31, 30, '0000-00-00', '13:00:00', 20, 'Bapteme', '2023-02-27 17:16:58');
